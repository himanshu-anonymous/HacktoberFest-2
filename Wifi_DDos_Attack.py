...
# This program is programed for educational and testing purposes only. If any activity which violates the rules is done with this program then the author (Sapphire.corp ) is not responsible for that.
